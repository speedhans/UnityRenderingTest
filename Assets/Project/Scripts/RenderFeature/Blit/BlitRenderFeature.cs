...
public class BlitRenderFeature : ScriptableRendererFeature
{
	...
	public class BlitRenderPass : ScriptableRenderPass
	{
		...
		public BlitRenderPass(RenderPassEvent renderPassEvent, BlitSettings settings, string tag)
		{
	...
	public BlitRenderPass blitPass;

	public override void Create()
	{
		var passIndex = settings.blitMaterial != null ? settings.blitMaterial.passCount - 1 : 1;
		settings.blitMaterialPassIndex = Mathf.Clamp(settings.blitMaterialPassIndex, -1, passIndex);
		blitPass = new BlitRenderPass(settings.Event, settings, name);
