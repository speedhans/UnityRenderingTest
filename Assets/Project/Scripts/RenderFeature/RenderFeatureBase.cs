...
public class RenderFeatureBase : ScriptableRendererFeature
{
    public class RenderFeatureBasePass : ScriptableRenderPass
    {
		...
		public RenderFeatureBasePass(RenderPassEvent renderPassEvent, BlitSettings settings, string tag)
		{
	...
	public RenderFeatureBasePass blitPass;

	public override void Create()
	{
		var passIndex = settings.blitMaterial != null ? settings.blitMaterial.passCount - 1 : 1;
		settings.blitMaterialPassIndex = Mathf.Clamp(settings.blitMaterialPassIndex, -1, passIndex);
		blitPass = new RenderFeatureBasePass(settings.Event, settings, name);
